...
1. **[en]** todo  
[fr] Les exemples (adaptés) de requêtes de la thèse d’Yves Raimond (pp. 148-150) :

1. **[en]** todo  
[fr] donne-moi toutes les pistes de ma collection d’enregistrements correspondant à des oeuvres de compositeurs allemands écrites entre 1800 et 1850 et exécutées au Royal Albert Hall

1. **[en]** todo  
[fr] donne-moi les pistes d’oeuvres d’artistes qui étaient fiancés l’un à l’autre

1. **[en]** todo  
[fr] donne-moi les noms et date de naissance des artistes de ma collection qui jouent du hautbois du Poitou

1. **[en]** todo  
[fr] donne-moi des paires de titres enregistrés qui sont composés dans la même tonalité

1. **[en]** todo  
[fr] donne-moi les artistes de ma collection qui ont été enregistrés plus de 10 fois par Radio France
